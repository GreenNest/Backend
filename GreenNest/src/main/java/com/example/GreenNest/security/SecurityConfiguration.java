    ...
    protected void configure(HttpSecurity http) throws Exception{
        ...
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().exceptionHandling()
                ...
                .authorizeRequests((request) -> request.antMatchers("/api/v1/auth/login", "/api/v1/customer", "/api/v1/employee","/api/v1/delete/{id}", "/api/v1/add/product","/api/v1/get/featured/{feature}","/api/v1/product/{id}",
                                "/api/v1/get/categories","/api/v1/employees","/api/v1/viewEmployees/{id}","/api/v1/deleteEmployee/{id}","/api/v1/addSupplier","/api/v1/addCategory/{id}","/api/v1/getSuppliers","/api/v1/deleteSupplier/{id}",
                                "/api/v1/product/{id}","/api/v1/deleteProduct/{id}").permitAll()

    ...
    protected void configure(HttpSecurity http) throws Exception{
        ...
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().exceptionHandling()
                ...
                .authorizeRequests((request) -> request.antMatchers("/api/v1/auth/login", "/api/v1/customer", "/api/v1/employee","/api/v1/delete/{id}", "/api/v1/add/product","/api/v1/get/featured/{feature}",
                                ...
                                "/api/v1/orders/cashOnDelivery","/api/v1/orderStatus/update/{id}/{status}","/api/v1/employee/salary/{type}", "/api/v1/invoice/send", "/api/v1/get/invoiceDetails/{id}","/api/v1/order/getCount",
